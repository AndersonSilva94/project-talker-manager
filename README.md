...
# Projeto Talker Manager :speaking_head:
...
1. Clone o repositório
  * `git clone git@github.com:AndersonSilva94/project-talker-manager.git`.
...
3. Rode os testes
  * Para isso você deve start a aplicação no terminal, basta rodar o comando:
    * `npm run dev`
